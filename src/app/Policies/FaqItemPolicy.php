...
class FaqItemPolicy
{
    ...
    {
        return $user->can('view_any_faq::item');
    }
    ...
    {
        return $user->can('create_faq::item');
    }
    ...
    {
        return $user->can('update_faq::item');
    }
    ...
    {
        return $user->can('delete_faq::item');
    }
    ...
    {
        return $user->can('delete_any_faq::item');
    }
     ...
     */
    public function replicate(User $user, FaqItem $faqItem): bool
    {
